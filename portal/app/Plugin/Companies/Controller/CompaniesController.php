    ...
    public function precadastro_teste($page = null) {
        ...
        if ($page == 'sucesso') {
            ...
            //$upload = $this->Utility->x_uploadFile('companies', $this->request->data ['Company'] ['logo']);
			 $upload = $this->Utility->adv_uploadFileComp('offers', $this->request->data ['Company'] ['logo']);
    ...
    // LAYOUT DA CADASTRO DE OFERTA COMPANY
     public function layoutCadOferta($page = null) {
	  ...
	  $pageName = "offers";
		...
		//CAPTURANDO TODOS OS ASSINANTES
        ...
        if ($page == 'requisicao') {
            ...
            if ($page == 'incluir') {
                ...
                if ($formType == 'insert') {
					...
					$param['Offer']['begins_at'] = $this->formataData2("23/07/2015");
					$param['Offer']['ends_at'] = $this->formataData2("31/08/2015");
                    ...
                    if (!empty($this->request->data['Offer']['Offer'])) {
                        //$upload = $this->Utility->x_uploadFile('offers', $this->request->data ['Offer'] ['photo']);
                        $upload = $this->Utility->adv_uploadFile('offers', $this->request->data ['Offer'] ['photo']);
...
//                }
	...
	//exclui usuario secundario
        ...
        if ($page == 'save-preferences') {
			...
			$compI = $this->Session->read('compPreferences.id');
        ...
        if ($page == 'save-social-network') {
			...
			$compNetId = $this->Session->read('compSocial.companies_social_networks.id');
            if (empty($compNetId)) {
        ...
        if ($page == 'updateCompany') {
            ...
            $this->set(compact('company', 'aparencia', 'secondUsers', 'companyPreference'));
    ...
    public function layoutVendas() {
        ...
        $this->set(compact('pendentes', 'pageName'));
        $this->set(compact('finalizadas'));
 ...
 from offers_statistics left join offers_comments on offers_statistics.offer_id = offers_comments.offer_id where offers_statistics.offer_id =" . $oferta['Offer']['id'] . ";";
...
//        }
    ...
    public function cadSecondaryUsers($page = null) {
        ...
        if ($page == 'insert') {
            ...
            $this->Utility->postEmailAutomatic('companies', 'secondaryUser', $data);
            //
